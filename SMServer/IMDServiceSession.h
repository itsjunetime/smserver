...
/*@implementation eg : NSObject
-(void)getBundle {
    void* handle = dlopen("/System/Library/PrivateFrameworks/IMDaemonCore.framework/", RTLD_NOW);
    Class c = NSClassFromString(@"IMDServiceSession");
    id instance = [[c alloc] init];
    dlclose(handle);
    [instance sendMessage:@"This is a test! If you did not expect to receive this, I apologize, and just respond to let me know." toChat:25 style:"1"]
}
@end*/
...
- (void)enqueReplayMessageCallback:(id)arg1;
