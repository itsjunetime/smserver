...
class Settings {
	var server_port = UserDefaults.standard.object(forKey: "port") as? String ?? "8741"
	var socket_port = UserDefaults.standard.object(forKey: "socket_port") as? Int ?? 8740
	var password = UserDefaults.standard.object(forKey: "password") as? String ?? "toor"
	
	var default_num_chats = UserDefaults.standard.object(forKey: "num_chats") as? Int ?? 40
	var default_num_messages = UserDefaults.standard.object(forKey: "num_messages") as? Int ?? 100
	var default_num_photos = UserDefaults.standard.object(forKey: "num_photos") as? Int ?? 40
